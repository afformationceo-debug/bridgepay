// prototypes/merchant-landing/page.tsx
// 가맹점 유치 랜딩페이지 프로토타입 - 3D 블록체인 UI 적용
      ...
      <div className="relative z-10 pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-slate-300 mb-10 max-w-3xl mx-auto drop-shadow"
          >
  ...
  const benefits = [
    {
      ...
      title: '수수료 최소화',
      description: '기존 카드결제 2.5~3.5% → 0.5% 이하로 수수료 대폭 절감',
      color: 'blue',
    },
    {
  ...
  return (
    <section className="py-20 px-4 bg-slate-800/50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-4">왜 Unify Pay인가요?</h2>
          <p className="text-slate-400">해외 환자 결제의 모든 불편함을 해결합니다</p>
        </motion.div>
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <FeatureCard3D className="h-full">
                <div className="p-6 bg-slate-800/80 rounded-2xl border border-slate-700/50 h-full">
                  <motion.div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 border ${colorClasses[benefit.color as keyof typeof colorClasses]}`}
    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">기존 결제 vs Unify Pay</h2>
          <p className="text-slate-400">한눈에 비교하세요</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-700/50">
                <th className="p-4 text-left text-slate-400 font-medium">항목</th>
                <th className="p-4 text-center text-slate-400 font-medium">기존 PG</th>
                <th className="p-4 text-center text-blue-400 font-medium bg-blue-500/5">Unify Pay</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-slate-700/30">
                <td className="p-4 text-white">결제 수수료</td>
                <td className="p-4 text-center text-slate-400">2.5% ~ 3.5%</td>
                <td className="p-4 text-center text-green-400 font-semibold bg-blue-500/5">0% ~ 0.5%</td>
              </tr>
              <tr className="border-b border-slate-700/30">
                <td className="p-4 text-white">정산 주기</td>
                <td className="p-4 text-center text-slate-400">D+3 ~ D+7</td>
                <td className="p-4 text-center text-green-400 font-semibold bg-blue-500/5">즉시 (D+0)</td>
              </tr>
              <tr className="border-b border-slate-700/30">
                <td className="p-4 text-white">해외 결제</td>
                <td className="p-4 text-center text-slate-400">추가 수수료</td>
                <td className="p-4 text-center text-green-400 font-semibold bg-blue-500/5">동일 수수료</td>
              </tr>
              <tr className="border-b border-slate-700/30">
                <td className="p-4 text-white">환율</td>
                <td className="p-4 text-center text-slate-400">불리한 환율</td>
                <td className="p-4 text-center text-green-400 font-semibold bg-blue-500/5">실시간 최적 환율</td>
              </tr>
              <tr>
                <td className="p-4 text-white">가입 난이도</td>
                <td className="p-4 text-center text-slate-400">복잡 (2-4주)</td>
                <td className="p-4 text-center text-green-400 font-semibold bg-blue-500/5">간편 (3일)</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <section id="how-it-works" className="py-20 px-4 bg-slate-800/50">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl font-bold text-white mb-4">결제는 이렇게 진행됩니다</h2>
          <p className="text-slate-400 mb-6">고객의 QR 스캔부터 정산까지, 블록체인 기반 실시간 결제 플로우</p>
        ...
        >
          {use3D ? (
            <PaymentFlowDemo3D autoPlay={true} className="max-w-4xl mx-auto" />
          ) : (
            <PaymentFlowDemo2D autoPlay={true} className="max-w-4xl mx-auto" />
          )}
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-bold text-white mb-4">가맹점 등록 절차</h3>
          <p className="text-slate-400">4단계로 간편하게 시작하세요</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {onboardingSteps.map((item, index) => (
            ...
            >
              ...
              <div className="relative bg-slate-800 p-6 rounded-2xl border border-slate-700/50 text-center hover:border-blue-500/50 transition-colors">
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-blue-500/25"
                >
                  {item.step}
                </motion.div>
  ...
  return (
    <section id="apply" className="py-20 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">가맹점 신청</h2>
          <p className="text-slate-400">아래 정보를 입력하시면 담당자가 연락드립니다</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-slate-400 text-sm text-center">
            ...
            <p>contact@afformation.io | 02-1234-5678</p>
          </div>
